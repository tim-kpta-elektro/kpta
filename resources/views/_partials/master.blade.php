                ...
                <ul class="nav-main">
                    ...
                    <li class="nav-main-item">
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{url('/kp/pelaksanaan/cetak_lmbr_tugas')}}">
                                    <span class="nav-main-link-name">Cetak Lembar Tugas KP</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{url('/kp/pelaksanaan/cetak_form_nilai')}}">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link" aria-haspopup="true" aria-expanded="false" href="{{url('/kp/seminarkp')}}">
                    ...
                    <li class="nav-main-item">
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{url('/ta/pengajuan_seminar')}}">
                                    <span class="nav-main-link-name">Pengajuan Seminar</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{url('/ta/laporan/daftar_hadir_dosen')}}" target="_blank">
                                    <span class="nav-main-link-name">Cetak Daftar Hadir Dosen</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{url('/ta/laporan/berita_acara')}}" target="_blank">
                                    <span class="nav-main-link-name">Cetak Berita Acara</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-main-item">
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{url('/ta/pengajuan_pendadaran')}}">
                                    <span class="nav-main-link-name">Pengajuan Pendadaran</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                    ...
                    <li class="nav-main-heading">Kerja Praktek</li>
                    <li class="nav-main-item">
                        <a class="nav-main-link" aria-haspopup="true" aria-expanded="false" href="{{url('/kp/pembimbing')}}">
                            <i class="nav-main-link-icon si si-book-open"></i>
