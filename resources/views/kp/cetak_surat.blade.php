...
<body>
    <div class="container">
        <div class="row">
            ...
            <br>
            <p style="text-align: justify;">Untuk pelaksanaan kerja praktek tersebut di atas dimohonkan  mulai tanggal <b>{{$data->tgl_mulai_kp}}</b> sampai <b>{{$data->tgl_selesai_kp}}</b> atau dalam waktu yang lain sesuai dengan kebijakan perusahaan Bapak/Ibu.</p>
