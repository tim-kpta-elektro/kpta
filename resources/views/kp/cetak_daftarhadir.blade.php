...
<html>
<head>
    <title>Form Daftar Hadir Seminar KP</title>
    ...
    <div class="container">
        <div class="row">
           <div class="col">
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 30%; text-align: center;">
                            <img src="https://www.google.com" style="height: 100px;" />
                        </td>
                ...
                <h2 style="text-align: center;">Daftar Hadir Seminar Kerja Praktek</h2>
                <table class="table1" style="width: 100%">    
                    <tr>
                        <td style="width: 35%;">Nama Mahasiswa</td>
                        <td style="width: 3%;">:</td>
                        <td style="width: 62%;"><strong>Yudhi Prabowo Kusuma</strong></td>
                    </tr>
                    <tr>
                        <td>NIM</td>
                        <td>:</td>
                        <td><strong>I0716034</strong></td>
                    </tr>
                    <tr>
                        <td>Judul Seminar KP</td>
                        <td>:</td>
                        <td><strong>I0716034</strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><strong>PT. Telkomsel</strong></td>
                    </tr>
                    <tr>
                        <td>Dosen Pembimbing</td>
                        <td>:</td>
                        <td><strong>Meiyanto Eko Sulistyo, S.T., M.Eng / 197705132009121004</strong></td>
                    </tr>
                    <tr>
